...
export const INITIAL_PROJECTS: Project[] = [
    // Shanghai Wuwu Tech Projects (org_wuwu)
    {
        ...
        members: [
            { id: 'pm1', name: '张伟', email: 'zhangsan@wuwu.tech', avatarBg: 'bg-primary', role: 'admin', source: 'internal', department: '工程部', joinedAt: '2026-05-20' },
            { id: 'pm2', name: '王钢', email: '138****8888', avatarBg: 'bg-amber-600', role: 'participant', source: 'internal', department: '总经办', joinedAt: '2026-05-20' },
            { id: 'pm3', name: '李娜', email: 'xuqin@kunshan-archives.cn', avatarBg: 'bg-rose-600', role: 'observer', source: 'external', department: '昆山市城建档案馆', joinedAt: '2026-06-01' },
        ]
    },
    {
        id: '2',
        ...
        members: [
            ...
            { id: 'pm5', name: '张伟', email: 'zhangsan@wuwu.tech', avatarBg: 'bg-primary', role: 'participant', source: 'internal', department: '工程部', joinedAt: '2026-05-20' },
            { id: 'pm6', name: '岑源', email: 'ruanfeng@kunshan-archives.cn', avatarBg: 'bg-sky-600', role: 'observer', source: 'external', department: '昆山市城建档案馆', joinedAt: '2026-05-28' },
        ]
    },
    {
        id: 'org_wuwu_m_3',
    ...
    },
    {
        ...
        members: [
            { id: 'pm7', name: '张伟', email: 'zhangsan@wuwu.tech', avatarBg: 'bg-primary', role: 'admin', source: 'internal', department: '工程部', joinedAt: '2026-05-20' },
