    ...
    return (
        <div className="flex-1 flex flex-col h-full overflow-hidden bg-bg">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                {/* Visual Header Banner - simplified to avoid double top bar */}
                <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm flex items-center gap-4">
                    <div className="relative group w-14 h-14 rounded-full overflow-hidden border-2 border-primary/25 bg-slate-100 shrink-0 select-none">
                        <img 
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-[11px] text-slate-400 mt-0.5">
                            部门：{identity.department || '总经办'} · 创建时间: <span className="font-mono">2024-10-31</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
                    ...
                    {/* Left Hand Tab list */}
                    <div className="bg-white rounded-2xl border border-slate-200 p-3 shadow-sm space-y-1 md:col-span-1 md:sticky md:top-0">
                        <button
