    ...
    return (
        <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200 space-y-6">
            <div className="flex items-start">
                <div className="w-16 h-16 bg-rose-50 border border-rose-100 rounded-lg flex items-center justify-center text-3xl mr-5">
                    <Building2 className="w-8 h-8 text-rose-600" />
                </div>
                <div className="flex-1">
                    <div className="flex items-center mb-2 flex-wrap gap-2">
                        <h2 className="text-lg font-bold text-slate-900 mr-2">昆山市城建档案馆</h2>
                        <span className="text-xs bg-rose-100 text-rose-700 px-2 py-0.5 rounded font-medium">政府机构</span>
                    </div>
